...
namespace HeCopUI_Framework.Controls
{
    ...
    //[ToolboxBitmap(typeof(HCircleAnglePicker), "CircleAnglePickerIcon.bmp")]
    public partial class HCircleAnglePicker : Control
    {
        /// <summary>
        ...
        /// </summary>
        private CircleAnglePickerType coreType = CircleAnglePickerType.Rectangle;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HCircleAnglePicker"/> class.
        /// </summary>
...
#pragma warning restore CS0109 // Member does not hide an inherited member; new keyword is not required
        ...
        [DefaultValue(typeof(CircleAnglePickerType), "Rectangle")]
        [SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1513:ClosingCurlyBracketMustBeFollowedByBlankLine", Justification = "Reviewed.")]
        [SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1516:ElementsMustBeSeparatedByBlankLine", Justification = "Reviewed.")]
        public CircleAnglePickerType CoreType
        {
            get
            {
                return coreType;
        ...
        {
            if (CoreType == CircleAnglePickerType.None)
            {
                return;
            }
            ...
            {
                if (CoreType == CircleAnglePickerType.Ellipse)
                {
                    g.FillEllipse
                    (
                      b,
